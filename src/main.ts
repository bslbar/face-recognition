...
const azureStorageProcessor: AzureStorageProcessor = new AzureStorageProcessor(
  settings.azure_storage
);
const azureImageAnalyzer: AzureImageAnalyzer = new AzureImageAnalyzer(
  settings.azure_vision
);
...
const AZURE_FILE = `${service.getContainerName(
  settings.azure_storage.containerName
)}_azure`;
const GOOGLE_FILE = `${service.getContainerName(
  settings.azure_storage.containerName
)}_google`;
